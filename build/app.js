...
var actions = {
	...
	reduceNumber: function reduceNumber(item) {
		var action = {
			type: 'REDUCE_NUMBER',
			id: item.CommodityId,
			price: item.CommodityPrice
	...
	createNumber: function createNumber(item) {
		var action = {
			type: 'CREATE_NUMBER',
			id: item.CommodityId,
			price: item.CommodityPrice
...
var _getRouteParams = __webpack_require__(101);
...
var _computeChangedRoutes2 = __webpack_require__(99);
...
var _getComponents = __webpack_require__(100);

var _getComponents2 = _interopRequireDefault(_getComponents);

var _matchRoutes = __webpack_require__(105);
...
exports.Head = exports.Index = undefined;
...
var Head = function (_React$Component2) {
    ...
    function Head(props, context) {
        ...
        var _this2 = _possibleConstructorReturn(this, (Head.__proto__ || Object.getPrototypeOf(Head)).call(this, props, context));
...
var Body = function (_React$Component3) {
    ...
    function Body(props, context) {
        ...
        var _this3 = _possibleConstructorReturn(this, (Body.__proto__ || Object.getPrototypeOf(Body)).call(this, props, context));
    ...
    _createClass(Body, [{
        ...
        value: function render() {
            return React.createElement(
                "div",
                { className: "body" },
                this.state.issuccess ? React.createElement(Componenta, { res: this.state.data.data.template.componentList }) : "",
                this.state.issuccess ? React.createElement(ComponentB, { res: this.state.data.data.template.componentList }) : ""
            );
        }
    }, {
...
var Componenta = function (_React$Component4) {
    _inherits(Componenta, _React$Component4);

    function Componenta(props, context) {
        _classCallCheck(this, Componenta);

        var _this4 = _possibleConstructorReturn(this, (Componenta.__proto__ || Object.getPrototypeOf(Componenta)).call(this, props, context));
    ...
    _createClass(Componenta, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(Componentb, { res: this.props.res }),
                React.createElement(Componentc, { res: this.props.res })
            );
        }
    }, {
        key: "createBanner",
        value: function createBanner(arr) {
            console.log(arr);
            var brr = [];
            arr[0].carouselPictures.forEach(function (item) {
                brr.push(React.createElement(
                    "div",
                    { className: "swiper-slide" },
                    React.createElement(
                        "a",
                        { href: "#/xiangqing" },
                        React.createElement("img", { src: item.pictureUrl })
                    )
                ));
            });
            return brr;
...
var Componentb = function (_React$Component5) {
    _inherits(Componentb, _React$Component5);

    function Componentb(props, context) {
        _classCallCheck(this, Componentb);

        return _possibleConstructorReturn(this, (Componentb.__proto__ || Object.getPrototypeOf(Componentb)).call(this, props, context));
    }
    ...
    _createClass(Componentb, [{
        ...
        key: "createEle",
        value: function createEle(arr) {
            var brr = [];
            brr.push(React.createElement(
                "a",
                { href: "#/xiangqing" },
                React.createElement("img", { src: arr[0].adPictures[0].pictureUrl })
            ));
            return brr;
        }
    }]);
...
var Componentc = function (_React$Component6) {
    _inherits(Componentc, _React$Component6);

    function Componentc(props, context) {
        _classCallCheck(this, Componentc);

        return _possibleConstructorReturn(this, (Componentc.__proto__ || Object.getPrototypeOf(Componentc)).call(this, props, context));
    }

    _createClass(Componentc, [{
        key: "render",
        value: function render() {
            return React.createElement(
                "div",
        ...
        value: function createEle(arr) {
            var brr = [];
            arr[0].componentNavs.forEach(function (item) {
                brr.push(React.createElement(
                    "div",
                    { className: "navitem" },
                    React.createElement("img", { src: item.pictureUrl }),
...
var ComponentB = function (_React$Component7) {
    _inherits(ComponentB, _React$Component7);

    function ComponentB(props, context) {
        _classCallCheck(this, ComponentB);

        var _this7 = _possibleConstructorReturn(this, (ComponentB.__proto__ || Object.getPrototypeOf(ComponentB)).call(this, props, context));
    ...
    _createClass(ComponentB, [{
                    ...
                    brr.push(React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "a",
                                { href: "#/xiangqing" },
                                React.createElement("img", { src: item.adPictures[0].pictureUrl })
                            )
                        ),
                        React.createElement("div", { className: "border" }),
                        React.createElement(
                            "div",
                            { className: "swiper-container itemswiper" },
                            React.createElement(
                                "div",
                                { className: "swiper-wrapper" },
        ...
        key: "createItem",
        value: function createItem(arr) {
            var crr = [];
            arr.forEach(function (item) {
                console.log(item);
                crr.push(React.createElement(
                    "div",
                    { className: "swiper-slide" },
                    React.createElement(
                        "div",
...
var _createDOMHistory = __webpack_require__(34);
...
var _deepEqual = __webpack_require__(69);
...
var _historyLibUseBasename = __webpack_require__(37);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_symbol_observable__ = __webpack_require__(125);
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    "a",
                                    { href: "#", "class": "qq", title: "\u4F7F\u7528QQ\u8054\u5408\u767B\u5F55" },
                                    "QQ"
                                ),
                                React.createElement(
                                    "a",
                                    { href: "#", "class": "weibo", title: "\u4F7F\u7528\u65B0\u6D6A\u5FAE\u535A\u8054\u5408\u767B\u5F55" },
                                    "\u65B0\u6D6A\u5FAE\u535A"
                                )
                            )
                        )
...
var Cutclass = function (_React$Component) {
    _inherits(Cutclass, _React$Component);

    function Cutclass(props, context) {
        _classCallCheck(this, Cutclass);

        var _this = _possibleConstructorReturn(this, (Cutclass.__proto__ || Object.getPrototypeOf(Cutclass)).call(this, props, context));
    ...
    _createClass(Cutclass, [{
        key: 'addList',
        value: function addList(arr) {
            var brr = [];
            var that = this;
        ...
        value: function addContent(arr) {
            ...
            arr[ind].Childs.forEach(function (item, i) {
                brr.push(React.createElement(
                    'a',
                    { href: '#/xiangqing', className: 'cA' },
                    React.createElement('img', { className: 'cImg', src: item.PictureUrl, alt: '' }),
                    React.createElement(
                        'p',
                        null,
                        item.CategoryName
        ...
        value: function componentDidMount() {
            this.getNews();
            var that = this;
            (0, _jquery2.default)(".navList").on('click', 'li', function () {
                (0, _jquery2.default)('.navList li').removeClass('Liactive');
                (0, _jquery2.default)(this).addClass('Liactive');
                that.setState({
                    ind: (0, _jquery2.default)(this).index()
                });
            });
        }
    }, {
        ...
        value: function render() {
            return React.createElement(
                'div',
                { className: 'box' },
                React.createElement(_index.Head, null),
                React.createElement(
                    'div',
                    { className: 'cutList' },
                    React.createElement(
...
var Eat = function (_React$Component) {
    _inherits(Eat, _React$Component);

    function Eat(props, context) {
        _classCallCheck(this, Eat);

        var _this = _possibleConstructorReturn(this, (Eat.__proto__ || Object.getPrototypeOf(Eat)).call(this, props, context));
    ...
    _createClass(Body, [{
        ...
        value: function render() {
            return React.createElement(
                "div",
                { className: "eat" },
                this.state.issuccess ? React.createElement(Componenta, { res: this.state.data.RspData.ArticleList.List }) : ""
            );
        }
    }, {
        key: "componentDidMount",
                ...
                brr.push(React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            "div",
                            null,
                            React.createElement("img", { src: item.AuthorPicture }),
                            item.Author
                        ),
                        React.createElement(
                            "span",
    ...
    _createClass(Root, [{
        ...
        value: function render() {
            return React.createElement(
                ...
                { className: 'index' },
                this.props.children,
                React.createElement(Footer, { pathname: this.props.location.pathname })
            );
        }
    }]);
...
var Footer = function (_React$Component2) {
    ...
    function Footer(props, context) {
        ...
        var _this2 = _possibleConstructorReturn(this, (Footer.__proto__ || Object.getPrototypeOf(Footer)).call(this, props, context));
    ...
    _createClass(Footer, [{
        key: 'getActive',
        value: function getActive(hash) {
            var active = this.props.pathname == '/' ? '/main' : this.props.pathname;
        ...
        value: function render() {
            return React.createElement(
                'div',
                { className: 'footer' },
                React.createElement(Iconitem, { iconclass: 'glyphicon glyphicon-home', spanname: '\u9996\u9875', href: '#/index', aclass: this.getActive("/index") }),
                React.createElement(Iconitem, { iconclass: 'glyphicon glyphicon-th-large', spanname: '\u5206\u7C7B', href: '#/cut', aclass: this.getActive("/cut") }),
                React.createElement(Iconitem, { iconclass: 'glyphicon glyphicon-plane', spanname: '\u5403\u996D\u5427', href: '#/eat', aclass: this.getActive("/eat") }),
                React.createElement(Iconitem, { iconclass: 'glyphicon glyphicon-shopping-cart', spanname: '\u8D2D\u7269\u8F66', href: '#/car', aclass: this.getActive("/car") })
            );
        }
    }]);
...
var Iconitem = function (_React$Component3) {
    _inherits(Iconitem, _React$Component3);

    function Iconitem(props, context) {
        _classCallCheck(this, Iconitem);

        var _this3 = _possibleConstructorReturn(this, (Iconitem.__proto__ || Object.getPrototypeOf(Iconitem)).call(this, props, context));
    ...
    _createClass(Iconitem, [{
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    'a',
                    { href: this.props.href, className: this.props.aclass },
...
var _pay = __webpack_require__(66);
...
var Car = function (_React$Component) {
    ...
    function Car(props, context) {
        ...
        var _this = _possibleConstructorReturn(this, (Car.__proto__ || Object.getPrototypeOf(Car)).call(this, props, context));

        _this.state = {
            isHas: _store2.default.getState().isHas
        };
        return _this;
    }
    ...
    _createClass(Car, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(Head, null),
                React.createElement(Body, null),
                this.state.isHas ? React.createElement(_pay2.default, null) : ''
            );
        }
    }, {
        key: 'componentDidMount',
    ...
    _createClass(Body, [{
        ...
        value: function render() {
            return React.createElement(
                'div',
                { className: 'car' },
                this.state.issuccess ? React.createElement(Componentb, { res: this.state.data.RspData.data.YgActivityFloors[0].ActivityFloorItems }) : "",
                this.state.issuccess ? React.createElement(Componenta, { res: this.state.data.RspData.data.YgActivityFloors[0].ActivityFloorItems }) : ""
            );
        }
    }, {
        key: 'componentDidMount',
...
var Componenta = function (_React$Component4) {
    ...
    function Componenta(props, context) {
        ...
        _this4.state = {
            list: _store2.default.getState().list
        };
        return _this4;
    }
    ...
    _createClass(Componenta, [{
        ...
        value: function createItem(arr) {
            ...
            arr.forEach(function (item) {
                brr.push(React.createElement(
                    'div',
                    { className: 'item-box' },
                    React.createElement('img', { src: item.SmallPic }),
                    React.createElement(
                        'p',
                        null,
                        item.CommodityName
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'span',
                            null,
                            React.createElement('img', { src: 'http://img06.yiguoimg.com/e/web/160623/01634/btnbuy.jpg', onClick: that.writeId.bind(item) })
                        )
                    )
                ));
            });
        ...
        key: 'writeId',
        value: function writeId() {
            _actions2.default.createNumber(this);
        }
    }, {
        key: 'componentDidMount',
        value: function componentDidMount() {
...
var Componentb = function (_React$Component5) {
    ...
    function Componentb(props, context) {
        ...
        var _this5 = _possibleConstructorReturn(this, (Componentb.__proto__ || Object.getPrototypeOf(Componentb)).call(this, props, context));
    ...
    _createClass(Componentb, [{
                        ...
                        brr.push(React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    React.createElement('span', { className: 'glyphicon glyphicon-trash', onClick: that.removeId.bind(item) })
                                ),
                                React.createElement(
                                    'div',
                                    { className: 'botbox' },
                                    ...
                                    React.createElement(
                                        'div',
                                        { className: 'numbox' },
                                        React.createElement('span', { className: 'glyphicon glyphicon-minus', onClick: that.reduceId.bind(item) }),
                                        React.createElement(
                                            'span',
                                            { className: 'spannum' },
                                            that.state.list[i].num
                                        ),
                                        React.createElement('span', { className: 'glyphicon glyphicon-plus', onClick: that.addId.bind(item) })
                                    )
                                )
                            )
                        ));
                        brr.push(React.createElement('div', { className: 'border' }));
                    }
                });
            }
        ...
        value: function addId() {
            _actions2.default.addNumber(this);
        }
    }, {
        key: 'reduceId',
        value: function reduceId() {
            _actions2.default.reduceNumber(this);
        }
    }, {
        key: 'removeId',
        value: function removeId() {
            _actions2.default.removeNumber(this);
        }
    }, {
        key: 'componentDidMount',
        value: function componentDidMount() {
...
var Xiangqing = function (_React$Component) {
    _inherits(Xiangqing, _React$Component);

    function Xiangqing(props, context) {
        _classCallCheck(this, Xiangqing);

        var _this = _possibleConstructorReturn(this, (Xiangqing.__proto__ || Object.getPrototypeOf(Xiangqing)).call(this, props, context));

        _this.state = {};
        return _this;
    }

    _createClass(Xiangqing, [{
        key: 'render',
        value: function render() {
            return React.createElement(
                'div',
            ...
            arr.forEach(function (item) {
                if (item.FloorItemType == 0) {
                    brr.push(React.createElement(
                        'div',
                        { className: 'flex-item' },
                        React.createElement('img', { src: item.FloorItemImgUrl })
                    ));
...
var _useRoutes2 = __webpack_require__(106);
...
var _PropTypes2 = __webpack_require__(9);
...
var _browserHistory2 = __webpack_require__(98);

var _browserHistory3 = _interopRequireDefault(_browserHistory2);

exports.browserHistory = _browserHistory3['default'];

var _hashHistory2 = __webpack_require__(102);

var _hashHistory3 = _interopRequireDefault(_hashHistory2);

exports.hashHistory = _hashHistory3['default'];

var _createMemoryHistory2 = __webpack_require__(44);
...
var _xiangqing = __webpack_require__(62);

var _xiangqing2 = _interopRequireDefault(_xiangqing);

var _shopcar = __webpack_require__(61);

var _shopcar2 = _interopRequireDefault(_shopcar);

var _cutclass = __webpack_require__(58);

var _cutclass2 = _interopRequireDefault(_cutclass);

var _eat = __webpack_require__(59);
...
ReactDOM.render(React.createElement(
    ...
    React.createElement(
        ...
        React.createElement(_reactRouter.IndexRoute, { component: _index.Index }),
        React.createElement(_reactRouter.Route, { path: '/index', component: _index.Index }),
        React.createElement(_reactRouter.Route, { path: '/xiangqing', component: _xiangqing2.default }),
        React.createElement(_reactRouter.Route, { path: '/car', component: _shopcar2.default }),
        React.createElement(_reactRouter.Route, { path: '/cut', component: _cutclass2.default }),
        React.createElement(_reactRouter.Route, { path: '/eat', component: _eat2.default }),
        React.createElement(_reactRouter.Route, { path: '*', component: _index.Index })
    )
...
var Pay = function (_React$Component) {
    ...
    function Pay(props, context) {
        _classCallCheck(this, Pay);

        var _this = _possibleConstructorReturn(this, (Pay.__proto__ || Object.getPrototypeOf(Pay)).call(this, props, context));
...
var reducer = function reducer() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { list: [], isHas: false };
...
var strictUriEncode = __webpack_require__(124);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(56), __webpack_require__(128)(module)))
